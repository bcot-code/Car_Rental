  ...
  return (
    <div className='bg-primary'>
      <div className='mx-auto max-w-[1900px] flex flex-col md:flex-row'>
        {/* SIDEBAR */}
        <div className='max-md:flexCenter flex flex-col justify-between
        bg-white sm:m-3 md:min-w-[20%] md:min-h-[97vh] rounded-xl
        shadow'>
          <div className='flex flex-col gap-y-6 max-md:items-center
          md:flex-col md:pt-5'>
            {/* LOGO & PROFILE */}
            <div className='w-full flex justify-between md:flex-col'>
              ...
              md:bg-primary rounded-b-xl p-2 pl-5 lg:pl-10 md:mt-10'>
                <UserButton
                  appearance={{
                    elements:{
                      userButtonAvatarBox: {
            ...
            <div className='flex md:flex-col md:gap-x-5 gap-y-8 md:mt-4'>
              ...
              {navItems.map((link) => (
                ...
                >
                  ...
                  className='hidden md:block' width={18}
                  />
                  <div>{link.label}</div>
                </NavLink>
              ))}
          ...
          {/* PROFILE for md and up */}
          <div className= 'hidden md:flex flex-col items-start gap-2 p-4 md:bg-primary rounded-b-xl mb-6'>
            <UserButton
              appearance={{
                elements:{
                  userButtonAvatarBox: {
            ...
            <Link 
              to="/" className="text-xs text-gray-500 hover:text-blue-600 flex transition mt-1">
                  ← Back to Home
            </Link>
          </div>
        </div>
