        ...
        <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
            <div className='max-w-80'>
                ...
                <div className='flex items-center gap-3 mt-4'>
                    <img src={assets.facebook} alt="facebook" className='w-7 h-7 cursor-pointer'/>
                    <img src={assets.twitter} alt="twitter" className='w-7 h-7 cursor-pointer'/>
                    <img src={assets.instagram} alt="instagram" className='w-7 h-7 cursor-pointer'/>
                    <img src={assets.linkedin} alt="linkedin" className='w-7 h-7 cursor-pointer'/>
                </div>
            </div>
            <div>
