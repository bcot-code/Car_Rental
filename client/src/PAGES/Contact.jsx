    ...
    <div className="bg-primary py-16 pt-28">
      <form className="flex flex-col items-center text-sm text-slate-800">
            ...
            <p className="max-md:text-sm text-gray-500 pb-10 text-center">
                Or just reach out manually to us at <a href="#" className="text-blue-500 hover:underline">hello@prebuiltui.com</a>
            </p>
            ...
            <div className="max-w-96 w-full px-4">
                ...
                <button type="submit" className="flexCenter gap-1 mt-5 btn-solid w-full !font-bold">
                    Submit Form
                    <img src={assets.right} alt='' width={15} className='invert'/>
                </button>
            </div>
        </form>
    </div>
